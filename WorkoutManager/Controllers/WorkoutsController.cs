...
namespace WorkoutManager.Controllers
{
    public class WorkoutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,DistanceInMeters,TimeInSeconds")] Workout workout)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,DistanceInMeters,TimeInSeconds")] Workout workout)
        {
            if (id != workout.Id)
            {
                return NotFound();
